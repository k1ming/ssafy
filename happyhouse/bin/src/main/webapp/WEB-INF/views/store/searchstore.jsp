...
<script type="text/javascript">
	...
	function update(selectedObj) {
		if (selectedObj.id == "upL") {
			...
			location.href = "${root}/mvsearchstore.do?dongcode=${param.dongcode}&key=upL&word="
					+ $("#upL option:selected").val();
		} else if (selectedObj.id == "upM") {
			location.href = "${root}/mvsearchstore.do?dongcode=${param.dongcode}&key=upM&word="
	...
	function searchStore() {
		...
		location.href = "${root}/searchstore.do?dongcode=${param.dongcode}&key="
				+ key + "&word=" + word;
	}
		...
		<div class="left col-lg-3">
			...
			<div style="padding-left: 30px">
				<c:forEach var="fav" items="${favlist }">
					<hr>
					<a href="${root }/mvsearchstore.do?dongcode=${fav.code}">
