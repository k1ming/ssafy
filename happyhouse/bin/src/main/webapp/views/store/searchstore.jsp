...
<script type="text/javascript">
	...
	function update(selectedObj) {
		if (selectedObj.id == "upL") {
			...
			location.href = "${root}/store.do?act=mvsearchstore&dongcode=${param.dongcode}&key=upL&word="
					+ $("#upL option:selected").val();
		} else if (selectedObj.id == "upM") {
			location.href = "${root}/store.do?act=mvsearchstore&dongcode=${param.dongcode}&key=upM&word="
	...
	function searchStore() {
		...
		location.href = "${root}/store.do?act=searchstore&dongcode=${param.dongcode}&key="
				+ key + "&word=" + word;
	}
...
<body>
	...
	<div class="row">
		<div class="left col-lg-3">
			<div align="center">관심 지역 목록</div>
			<div style="padding-left: 30px">
				<c:forEach var="fav" items="${favlist }">
					<hr>
					<a href="${root }/store.do?act=mvsearchstore&dongcode=${fav.code}">
						${fav.sido } / ${fav.sigungu } / ${fav.dong } </a>&nbsp
				<a href="${root }/user.do?act=delfavarea&dongcode=${fav.code}"
		...
		<div class="right col-lg-9">
			<div id="searchform" method="get" class="form">
				<div class="row">
