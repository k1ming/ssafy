...
<script type="text/javascript">
	...
	function update(selectedObj) {
		if (selectedObj.id == "upL") {
			...
			location.href = "mvsearchstore.do?dongcode=${param.dongcode}&key=upL&word="
					+ $("#upL option:selected").val();
		} else if (selectedObj.id == "upM") {
			location.href = "mvsearchstore.do?dongcode=${param.dongcode}&key=upM&word="
	...
	function searchStore() {
		...
		location.href = "searchstore.do?dongcode=${param.dongcode}&key="
				+ key + "&word=" + word;
	}
