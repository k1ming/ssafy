...
public class HousePageBean implements Serializable {
	...
	/**조회할 페이지 번호*/			// 현재 페이지 번효(currentPage)
	private int 	pageNo;
	/**한 페이지에 표시할 데이타 수*/	// 한 페이지 당 글 개수(sizePerPage)
	...
	public String toString() {
		return "HousePageBean [city=" + city + ", dong=" + dong + ", dongcode=" + dongcode + ", aptname=" + aptname
				+ ", dealtype=" + dealtype + ", searchType=" + Arrays.toString(searchType) + ", limitStart="
				+ limitStart + ", limitEnd=" + limitEnd + ", pagelink=" + pagelink + ", pageNo=" + pageNo
